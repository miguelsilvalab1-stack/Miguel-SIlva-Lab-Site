...
export const metadata: Metadata = {
  title: 'Política de Privacidade — Crowe Strategy Studio',
  description: 'Como o Crowe Strategy Studio recolhe, usa e protege os teus dados pessoais.',
}
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="text-[#a1a1aa] text-sm leading-relaxed space-y-3">
              <p>Quando utiliza o Crowe Strategy Studio, recolhemos os seguintes dados pessoais:</p>
          ...
          <section>
            ...
            <div className="text-[#a1a1aa] text-sm leading-relaxed space-y-3">
              ...
              <p>
                ...
                <a href="https://www.cnpd.pt" target="_blank" rel="noopener noreferrer" className="text-[#F5A800] hover:underline">
          ...
          <section>
            ...
            <p className="text-[#a1a1aa] text-sm leading-relaxed">
              O Crowe Strategy Studio utiliza apenas cookies técnicos estritamente necessários ao funcionamento da aplicação (ex: manutenção de sessão). Não utilizamos cookies de rastreamento, publicidade ou análise comportamental de terceiros sem o seu consentimento explícito.
            </p>
          </section>
          ...
          {/* Contacto */}
          <div className="bg-[#111111] border border-[#F5A800]/20 rounded-xl p-6 mt-8">
      ...
      <footer className="border-t border-[#27272a] px-6 py-6 mt-8">
        <div className="mx-auto max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-[#71717a]">
          ...
          <div className="flex items-center gap-4">
            <Link href="/privacidade" className="text-[#F5A800] hover:underline">Política de Privacidade</Link>
