...
export const metadata: Metadata = {
  title: 'Termos de Serviço — Crowe Strategy Studio',
  description: 'Condições de utilização do serviço Crowe Strategy Studio.',
}
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f5]">
      ...
      <header className="border-b border-[#27272a] px-6 py-4">
        <div className="mx-auto max-w-3xl flex items-center justify-between">
          <Link href="/diagnostico" className="flex items-center gap-2">
            <span className="text-[#F5A800] font-bold text-xl">Crowe</span>
            <span className="text-xs bg-[#F5A800]/10 text-[#F5A800] border border-[#F5A800]/20 px-2 py-0.5 rounded-full">Strategy Studio</span>
          </Link>
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        <div className="mb-10">
          <p className="text-sm text-[#F5A800] mb-2">Última atualização: 18 de fevereiro de 2026</p>
          <h1 className="text-3xl font-bold text-[#f4f4f5] mb-4">Termos de Serviço</h1>
          <p className="text-[#a1a1aa]">
            Ao utilizar o Crowe Strategy Studio, aceita os presentes Termos de Serviço. Leia-os com atenção antes de prosseguir.
          </p>
        </div>
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="text-[#a1a1aa] text-sm leading-relaxed space-y-1">
              <p><strong className="text-[#f4f4f5]">Serviço:</strong> Crowe Strategy Studio</p>
              <p><strong className="text-[#f4f4f5]">Responsável:</strong> Crowe Advisory PT (versão de validação interna — texto a rever pelo departamento legal)</p>
              <p><strong className="text-[#f4f4f5]">Website:</strong> crowe-strategy-studio.vercel.app</p>
              <p><strong className="text-[#f4f4f5]">Contacto:</strong>{' '}
                <a href="mailto:privacidade@miguelsilvalab.pt" className="text-[#F5A800] hover:underline">
          ...
          <section>
            ...
            <div className="text-[#a1a1aa] text-sm leading-relaxed space-y-3">
              <p>Para utilizar o Crowe Strategy Studio, o utilizador compromete-se a:</p>
          ...
          <section>
            ...
            <div className="bg-[#111111] border border-[#F5A800]/20 rounded-xl p-5 text-sm text-[#a1a1aa] leading-relaxed space-y-3">
              <p className="text-[#f4f4f5] font-medium">⚠️ Declaração obrigatória — AI Act da UE (Regulamento UE 2024/1689)</p>
              <p>
                O plano de negócio entregue pelo Crowe Strategy Studio é <strong className="text-[#f4f4f5]">gerado automaticamente por sistemas de inteligência artificial</strong> e deve ser tratado como um instrumento de apoio à decisão, não como aconselhamento profissional vinculativo.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="text-[#a1a1aa] text-sm leading-relaxed space-y-2">
              <p>
                O código-fonte, design, marca e elementos visuais do Crowe Strategy Studio são propriedade do Miguel Silva Lab e estão protegidos por direitos de autor.
              </p>
              <p>
          ...
          <section>
            ...
            <p className="text-[#a1a1aa] text-sm leading-relaxed">
              ...
              <Link href="/privacidade" className="text-[#F5A800] hover:underline">
          ...
          <div className="bg-[#111111] border border-[#27272a] rounded-xl p-6 mt-8">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#F5A800] hover:bg-[#a0563f] text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors"
            >
              privacidade@miguelsilvalab.pt
            </a>
          </div>
      ...
      <footer className="border-t border-[#27272a] px-6 py-6 mt-8">
        <div className="mx-auto max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-[#71717a]">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/termos" className="text-[#F5A800] hover:underline">Termos de Serviço</Link>
            <Link href="/diagnostico" className="hover:text-[#a1a1aa]">Voltar ao início</Link>
          </div>
        </div>
      </footer>
    </div>
