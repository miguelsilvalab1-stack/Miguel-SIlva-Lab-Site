...
const TABS: Tab[] = [
  { id: 'resumo_executivo',      label: 'Sumário Executivo',          shortLabel: 'Sumário',       icon: '01' },
  { id: 'analise_mercado',       label: 'Análise Setorial',           shortLabel: 'Setor',         icon: '02' },
  { id: 'estrategia_comercial',  label: 'Posicionamento & Comercial', shortLabel: 'Posicionamento', icon: '03' },
  { id: 'plano_financeiro',      label: 'Análise Financeira',         shortLabel: 'Finanças',      icon: '04' },
  { id: 'plano_operacional',     label: 'Operações & IA',             shortLabel: 'Operações',     icon: '05' },
  { id: 'marketing_comunicacao', label: 'Go-to-Market',               shortLabel: 'Marketing',     icon: '06' },
  { id: 'proximos_passos',       label: 'Roteiro 90 Dias',            shortLabel: 'Roteiro',       icon: '07' },
]
      ...
      <div className="premium-banner mt-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            >
              Transforme este diagnóstico em resultados
            </p>
            <p
              className="text-sm"
