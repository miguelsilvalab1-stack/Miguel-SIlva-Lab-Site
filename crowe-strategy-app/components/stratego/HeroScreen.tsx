...
export default function HeroScreen() {
  ...
  function handleSubmit(value: string) {
    ...
    if (!trimmed) return
    router.push(`/diagnostico/questionario?ideia=${encodeURIComponent(trimmed)}`)
  }
  ...
  return (
    ...
    >
      ...
      >
        Descreva a sua empresa e o desafio que enfrenta. Em poucos minutos
        recebe um diagnóstico estratégico preliminar, preparado para ser
        aprofundado com um consultor Crowe.
      </p>
      ...
      <div className="input-pill" style={{ maxWidth: 540 }}>
        <input
          ...
          onKeyDown={handleKey}
          placeholder="Ex.: empresa metalomecânica em Aveiro, 35 colaboradores…"
          autoFocus
