...
const QUESTIONS: Question[] = [
  {
    id: 'ideia',
    label: 'Descreva a sua empresa e o principal desafio estratégico',
    type: 'text',
    placeholder: 'Ex.: empresa metalomecânica em Aveiro, 35 colaboradores, quer diversificar mercados…',
  },
  {
    id: 'sector',
    label: 'Em que setor opera a empresa?',
    type: 'single',
    options: [
      'Indústria & Produção',
      'Retalho / Comércio',
  ...
  {
    id: 'localizacao',
    label: 'Qual o âmbito geográfico de atuação?',
    type: 'single',
    options: [
      'Local / Regional',
      'Nacional',
  ...
  {
    id: 'investimento',
    label: 'Qual a dimensão da empresa (volume de negócios anual)?',
    type: 'single',
    options: [
      'Menos de 500 000 €',
      '500 000 € – 2 M€',
      '2 M€ – 10 M€',
      'Mais de 10 M€',
      'Em arranque / sem histórico',
    ],
  },
  {
    id: 'diferencial',
    label: 'O que diferencia a empresa da concorrência?',
    type: 'text',
    placeholder: 'Qualidade, especialização, relação com clientes, tecnologia, preço…',
  },
  {
    id: 'objetivo',
    label: 'Qual a prioridade estratégica para os próximos 12–24 meses?',
    type: 'multi',
    options: [
      'Crescer vendas e quota de mercado',
      'Melhorar margens e eficiência',
      'Digitalizar e adotar IA',
      'Internacionalizar',
      'Profissionalizar a gestão / sucessão',
    ],
  },
]
...
export default function QuestionnaireV1() {
  ...
  function submitForm(finalAnswers: Record<string, string | string[]>) {
    ...
    router.push(`/diagnostico/loading?${params.toString()}`)
  }
